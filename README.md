...
**Python backend engineer.** I build things at the intersection of concurrency, parallelism, and web frameworks. Currently exploring what Python looks like without the GIL - building [barq](https://github.com/grandimam/barq), a threaded HTTP framework for free-threaded Python 3.13+, and [wasl](https://github.com/grandimam/wasl), a minimal ASGI framework. I write about what I learn along the way.
